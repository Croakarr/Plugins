...
async function setup(croakarr: any, logger: any): Promise<Config> {
    let core = {
        ...
        events: [
            {
                name: "Test",
                shortDesc: "Receive test events from Radarr",
            ...
            {
                name: "Download",
                shortDesc: "Receive import details from Radarr",
                description: "An event emitted when Radarr imports a completed media asset into the user's library.",
                enabled: false,
                hooks: [],
            ...
            {
                name: "Grab",
                shortDesc: "Receive download details from Radarr",
                description: "An event emitted when Radarr grabs an applicable download asset for the user's library.",
                enabled: false,
                hooks: [],
                event: "radarr.grab",
                handler: handleGrab
